...
function Get-TargetResource
{
    ...
    $config = Get-RDDeploymentGatewayConfiguration -ConnectionBroker $ConnectionBroker -ErrorAction SilentlyContinue
...
function Set-TargetResource
{
    ...
    if ($GatewayServer)
    {
        ...
        $servers = Get-RDServer -ConnectionBroker $ConnectionBroker | Where-Object { $_.Roles -eq "RDS-Gateway" }
